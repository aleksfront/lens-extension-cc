...
export const useClusterLoader = function (
  ...
  const {
    state: { loading: basicAuthLoading, loaded: basicAuthLoaded },
  ...
  // 0. Load the config object
  // DEBUG REMOVE? this is happening in Login now, or still needs to happen automatically?
  // useEffect(
  //   function () {
  //     if (
  ...
  useEffect(
    function () {
      if (
        ...
        // DEBUG REMOVE
        console.log(
          '=== NOT doing auth, basicAuthLoading=',
          basicAuthLoading,
          'basicAuthLoaded=',
          basicAuthLoaded,
          'activeEventType=',
  ...
  useEffect(
    function () {
      if (
        ...
        // DEBUG REMOVE
        console.log(
          '=== NOT loading cluster data, clusterDataLoading=',
          clusterDataLoading,
          'clusterDataLoaded=',
          clusterDataLoaded,
          'onlyNamespaces=',
